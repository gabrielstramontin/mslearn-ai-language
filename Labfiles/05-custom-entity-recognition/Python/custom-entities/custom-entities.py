        ...
        for doc, custom_entities_result in zip(files, document_results):
            ...
            if custom_entities_result.kind == "CustomEntityRecognition":
                for entity in custom_entities_result.entities:
                    print("\tEntity '{}' has category '{}' with confidence score of '{}'".format(entity.text, entity.category, entity.confidence_score))
...
# At the end, in the integrated terminal, enter the following command to run the program: [python custom-entities.py]
